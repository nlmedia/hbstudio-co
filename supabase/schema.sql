...
create table if not exists public.hb_templates (
  ...
  currency text not null default U&'\20AC',
...
-- path in the private "deliverables" bucket, and spec Sec.10.1 requires that this
...
-- `package` and filters by entitlement (Sec.5.4) instead of a table-level policy.
